...
include_once dirname(__DIR__) . "/src/IpLocationSeekerBinary.php";
include_once dirname(__DIR__) . "/src/IpLocationSeekerBinaryExtension.php";
include_once dirname(__DIR__) . "/src/IpLocationSeekerSqlite.php";
